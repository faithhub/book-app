                                ...
                                <div class="d-flex align-items-center">
                                    <div class="col-sm-5 p-0 position-relative image-overlap-shadow">
                                        <a href="javascript:void();">
                                            @if($book->book->book_cover_type == "Book Cover")
                                            <img class="img-fluid rounded w-100" src="{{ asset('BOOKCOVER/'.$book->book->book_cover) }}" alt="">
                                            @elseif($book->book->book_cover_type == "Video Cover")
                                            <div class="embed-responsive embed-responsive-1by1">
                                                <iframe class="embed-responsive-item" src="{{ asset('VIDEOCOVER/'.$book->book->video_cover) }}" allowfullscreen></iframe>
                                            </div>
                                            @endif
                                        </a>
                                    </div>
                                    <div class="col-sm-7">
                                        <div class="mb-2">
                                            <h6 class="mb-1">{{$book->book->book_name}}</h6>
                                            </span>
                                        ...
                                        <div class="price d-flex align-items-center">
                                            <h6><b>
                                                    @if($book->book->book_paid_free == "Paid")
                                                    ₦{{number_format($book->book->book_price, 2)}}
                                                    @else
                                                    Free
                                                    @endif
                                                </b>
                                        ...
                                        <div class="mb-2 d-flex align-items-center mt-2">
                                            <a href="{{ url('user/view-book/'.$book->book->book_name.'/'.$book->book->id) }}" class="btn btn-primary btn-sm mt-3">View Book</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
