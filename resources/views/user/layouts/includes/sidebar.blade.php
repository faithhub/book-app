    ...
    <div id="sidebar-scrollbar">
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                <li>
                    <a href="#dashboard" class="iq-waves-effect" data-toggle="collapse" aria-expanded="false"><span class="ripple rippleEffect"></span><i class="ri-file-pdf-line iq-arrow-left"></i><span>My Library</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    <ul id="dashboard" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li><a href=""><i class="ri-file-pdf-line"></i>Bought Book</a></li>
                        <li><a href=""><i class="ri-file-pdf-line"></i>Rent Books</a></li>
                    </ul>
                </li>
                
                <li>
                    <a href="admin-dashboard.html" class="active"><i class="ri-file-pdf-line"></i>Saved List</a>
                </li>
                
                <li>
                    <a href="#settings" class="iq-waves-effect" data-toggle="collapse" aria-expanded="false"><span class="ripple rippleEffect"></span><i class="ri-file-pdf-line iq-arrow-left"></i><span>Settings</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    <ul id="settings" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li><a href=""><i class="ri-file-pdf-line"></i>Profile</a></li>
                        <li><a href=""><i class="ri-file-pdf-line"></i>Change Password</a></li>
                    </ul>
                </li>
                
                <li>
                    <a href="admin-dashboard.html" class="active"><i class="ri-file-pdf-line"></i>Logout</a>
                </li>
                <li class="active active-menu">
