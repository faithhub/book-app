...
<div id="content-page" class="content-page">
    <div class="iq-card">
        <div class="iq-card-body">
            <form class="col-12 d-flex mt-3" method="POST" action="{{ route('user.search') }}">
                @csrf
                <input type="hidden" name="type" value="Material">
                <div class="form-group col-md-12">
                    <select class="select form-control" onchange='if(this.value != "") { this.form.submit(); }' name="mat_id" id="exampleFormControlSelect1">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                        <div class="iq-card-header d-flex justify-content-between align-items-center position-relative mb-0 similar-detail">
                            <div class="iq-header-title">
                                <h4 class="card-title mb-0">Featured Materials</h4>
                            </div>
                            <div class="iq-card-header-toolbar d-flex align-items-center">
                        ...
                        <ul id="" class="list-inline p-0 mb-0 row">
                            ...
                            <li class="col-md-12">
                                <div class="d-flex align-items-center">
                                    <div class="col-sm-5 p-0 position-relative">
                                        <a href="javascript:void();">
                                            @if($featured->book_cover_type == "Book Cover")
                                            <img class="img-fluid rounded w-100" src='{{ asset("BOOKCOVER/$featured->book_cover") }}' alt="">
                                            @elseif($featured->book_cover_type == "Video Cover")
                                            <video class="embed-responsive embed-responsive-1by1" loop controls muted>
                                                <source src="{{ asset('VIDEOCOVER/'.$featured->video_cover) }}" type="video/mp4" />
                                            </video>
                                            @endif
                                        </a>
                                    </div>
                                    <div class="col-sm-7">
                                        <div class="mb-2">
                                            <h6 class="mb-1">{{$featured->book_name}}</h6>
                                            <p class="font-size-13 line-height mb-1">{{$featured->book_author}}</p>
                                            <div class="d-block">
                                                <span class="font-size-20 text-warning">
                                                    @if(isset($featured->rate))
                                                    @if($featured->rating == 1)
                                                    <i class="fa fa-star mr-1"></i>
                                                    <i class="fa fa-star mr-1" style="color: gray;"></i>
                                                    <i class="fa fa-star mr-1" style="color: gray;"></i>
                                                    <i class="fa fa-star mr-1" style="color: gray;"></i>
                                                    <i class="fa fa-star mr-1" style="color: gray;"></i>
                                                    @elseif($featured->rating == 2)
                                                    <i class="fa fa-star mr-1"></i>
                                                    <i class="fa fa-star mr-1"></i>
                                                    <i class="fa fa-star mr-1" style="color: gray;"></i>
                                                    <i class="fa fa-star mr-1" style="color: gray;"></i>
                                                    <i class="fa fa-star mr-1" style="color: gray;"></i>
                                                    @elseif($featured->rating == 3)
                                                    <i class="fa fa-star mr-1"></i>
                                                    <i class="fa fa-star mr-1"></i>
                                                    <i class="fa fa-star mr-1"></i>
                                                    <i class="fa fa-star mr-1" style="color: gray;"></i>
                                                    <i class="fa fa-star mr-1" style="color: gray;"></i>
                                                    @elseif($featured->rating == 4)
                                                    <i class="fa fa-star mr-1"></i>
                                                    <i class="fa fa-star mr-1"></i>
                                                    <i class="fa fa-star mr-1"></i>
                                                    <i class="fa fa-star mr-1"></i>
                                                    <i class="fa fa-star mr-1" style="color: gray;"></i>
                                                    @elseif($featured->rating == 5)
                                                    <i class="fa fa-star mr-1"></i>
                                                    <i class="fa fa-star mr-1"></i>
                                                    <i class="fa fa-star mr-1"></i>
                                                    <i class="fa fa-star mr-1"></i>
                                        ...
                                        <div class="price d-flex align-items-center">
                                            <h6><b>
                                                    @if($featured->book_paid_free == "Paid")
                                                    ₦{{number_format($featured->book_price, 2)}}
                                                    @else
                                                    Free
                                                    @endif
                                                </b>
                                        ...
                                        <div class="iq-product-action">
                                            ...
                                            @if(in_array($featured->id, $boughts_books))
                                            <i class="ri-shopping-cart-2-fill p-1 text-primary cart btn" style="cursor: text;">Bought</i>
                                            @elseif(in_array($featured->id, $rented_books))
                                            <i class="ri-shopping-cart-2-fill p-1 text-primary cart btn" style="cursor: text;">Rent</i>
                                            @elseif(in_array($featured->id, $carts))
                                            <i class="ri-shopping-cart-2-fill p-1 text-primary cart btn" style="cursor: text;">Added</i>
                                            @else
                                            <form action="{{ route('user.add.cart') }}" method="POST">
                                                @csrf
                                                <input type="hidden" name="book_id" value="{{$featured->id}}">
                                                <button id="add-to-cart" class="p-1 rounded"><i class="ri-shopping-cart-2-fill text-primary cart shadow">Add to Cart</i></button>
                                            </form>
                                            @endif
                                            @else
                                        ...
                                        <div class="mb-2 d-flex align-items-center mt-2">
                                            <a href="{{ url('user/view-book/'.$featured->book_name.'/'.$featured->id) }}" class="btn btn-primary btn-sm mt-3">View Book</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                ...
                <div class="col-md-6">
                    <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                        <div class="iq-card-header d-flex justify-content-between align-items-center position-relative mb-0 similar-detail">
                            <div class="iq-header-title">
                                <h4 class="card-title mb-0">Google Ads</h4>
                            </div>
                            <div class="iq-card-header-toolbar d-flex align-items-center">
                            </div>
                        </div>
