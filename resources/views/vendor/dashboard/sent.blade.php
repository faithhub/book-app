                        ...
                        <table class="data-tables table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ date('D, M j, Y \a\t g:ia', strtotime($message->created_at))}}</td>
                                    <td> <a href="#"><button type="submit" data-toggle="modal" data-target="#viewMessageSent{{$message->id}}" class="btn btn-primary view-more">View</button></a></td>
                                </tr>
                                <!-- Modal -->
